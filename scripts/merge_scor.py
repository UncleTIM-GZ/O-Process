...
# fmt: off
SCOR_PROCESSES = [
    ("sP1", "Plan Supply Chain", "4.1", [
        "Identify and prioritize SC requirements",
        "Balance SC resources with requirements",
        "Establish and communicate SC plans",
    ]),
    ("sP2", "Plan Source", "4.1", [
        "Identify and assess source requirements",
        "Balance source resources",
    ...
    ("sP4", "Plan Deliver", "4.1", [
        "Identify delivery requirements",
        "Balance delivery resources",
        "Establish delivery plans",
    ]),
    ("sP5", "Plan Return", "4.1", [
        "Assess return requirements",
        "Balance return resources",
        "Establish return plans",
    ]),
    ("sS1", "Source Stocked Product", "4.2", [
        "Schedule product deliveries",
        "Receive product",
        "Verify product",
        "Transfer product",
    ]),
    ("sS2", "Source Make-to-Order Product", "4.2", [
        "Schedule deliveries",
        "Receive product",
        "Verify product",
        "Transfer product",
    ]),
    ("sS3", "Source Engineer-to-Order Product", "4.2", [
        "Identify sources of supply",
        "Select final supplier",
        "Schedule deliveries",
        "Receive product",
    ]),
    ("sM1", "Make-to-Stock", "4.3", [
        "Schedule production",
        "Issue material",
        "Produce and test",
        "Package",
    ...
    ("sM2", "Make-to-Order", "4.3", [
        "Schedule production",
        "Issue sourced product",
        "Produce and test",
        "Package",
        "Release to deliver",
    ]),
    ("sM3", "Engineer-to-Order", "4.3", [
    ...
    ("sD1", "Deliver Stocked Product", "4.4", [
    ...
    ("sD2", "Deliver Make-to-Order Product", "4.4", [
        "Process inquiry and quote",
        "Receive and validate order",
        "Reserve resources",
        "Consolidate orders",
    ...
    ("sD3", "Deliver Engineer-to-Order Product", "4.4", [
        "Obtain and respond to RFP/RFQ",
        "Negotiate and receive contract",
        "Schedule installation",
        "Install product",
    ]),
    ("sD4", "Deliver Retail Product", "4.4", [
        "Generate stocking schedule",
        "Receive product at store",
        "Pick from backroom",
        "Stock shelf",
        "Checkout",
    ]),
    ("sSR1", "Source Return Defective Product", "4.0", [
        "Identify defective condition",
        "Request return authorization",
        "Schedule shipment",
        "Return product",
    ]),
    ("sSR2", "Source Return MRO Product", "4.0", [
        "Identify MRO condition",
        "Request return authorization",
        "Schedule shipment",
        "Return product",
    ]),
    ("sSR3", "Source Return Excess Product", "4.0", [
        "Identify excess product",
        "Request return authorization",
        "Schedule shipment",
        "Return product",
    ]),
    ("sDR1", "Deliver Return Defective Product", "4.0", [
        "Authorize return",
        "Schedule return receipt",
        "Receive product",
        "Transfer product",
    ]),
    ("sDR2", "Deliver Return MRO Product", "4.0", [
        "Authorize return",
        "Schedule receipt",
        "Receive product",
        "Transfer product",
    ]),
    ("sDR3", "Deliver Return Excess Product", "4.0", [
        "Authorize return",
        "Schedule receipt",
        "Receive product",
        "Transfer product",
    ]),
    ("sE1", "Manage SC Business Rules", "4.0", [
        "Gather business rule info",
        "Interpret rules",
        "Document rules",
    ]),
    ("sE2", "Manage SC Performance", "4.0", [
        "Initiate reporting",
        "Analyze reports",
        "Develop corrective actions",
    ]),
    ("sE3", "Manage SC Data and Information", "4.0", [
        "Receive and compile data",
        "Maintain data integrity",
    ]),
    ("sE4", "Manage SC Human Resources", "4.0", [
        "Identify skill requirements",
        "Identify available resources",
        "Match skills",
    ]),
    ("sE5", "Manage SC Assets", "4.0", [
        "Schedule asset management",
        "Maintain assets",
        "Configure assets",
    ]),
    ("sE6", "Manage SC Contracts", "4.0", [
        "Negotiate contracts",
        "Establish contracts",
        "Manage contracts",
    ]),
    ("sE7", "Manage SC Network", "4.0", [
        "Select network model",
        "Evaluate alternatives",
        "Finalize network",
    ]),
    ("sE8", "Manage SC Regulatory Compliance", "4.0", [
        "Monitor requirements",
        "Assess compliance",
        "Adapt to changes",
    ]),
    ("sE9", "Manage SC Risk", "4.0", [
        "Identify SC risks",
        "Assess probability and impact",
        "Mitigate risks",
    ]),
    ("sE10", "Manage SC Technology", "4.0", [
        "Define tech requirements",
        "Select solutions",
        "Implement technology",
    ]),
    ("sE11", "Manage SC Sustainability", "4.0", [
        "Define objectives",
        "Measure performance",
        "Improve practices",
    ]),
    ("sP-SVC", "Plan Service Operations", "5.1", [
        "Forecast service demand",
        "Plan resource allocation",
        "Balance capacity",
    ]),
    ("sD-SVC", "Deliver Service Operations", "5.3", [
        "Schedule delivery",
        "Execute delivery",
        "Confirm completion",
    ]),
